...
const COPY: Record<Locale,Record<string,Copy>> = {
  en:{
    ...
    v3_hero_images:{body:Array.from({length:12},(_,index)=>`https://bunfdlazirfheomhvjdz.supabase.co/storage/v1/object/public/homepage-media/V3/hero-${String(index+1).padStart(2,'0')}.webp`).join('\n')},
