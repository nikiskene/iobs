...
export default function PrivacyPage() {
  return <PolicyPage eyebrow="Data protection" title="Privacy policy">
    <section><h2>Who is responsible</h2><p>IACy International FZCO, Dubai Airport Freezone, Dubai, United Arab Emirates, is the controller of personal data processed through this website. Contact us at <a href="mailto:hello@worldos.institute">hello@worldos.institute</a>.</p></section>
