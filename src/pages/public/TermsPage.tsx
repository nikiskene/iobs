...
export default function TermsPage() {
  return <PolicyPage eyebrow="Website use" title="Terms">
    <section><h2>Scope</h2><p>These terms govern use of the Institute of Beautiful Success website operated by IACy International FZCO. Specific awards, events, expeditions, memberships, purchases, or partnerships may be subject to additional terms presented before you commit.</p></section>
    <section><h2>Permitted use</h2><p>You may use this website only lawfully and without infringing the rights of others, disrupting the service, attempting unauthorised access, or submitting misleading, unlawful, or harmful material.</p></section>
    <section><h2>Your submissions</h2><p>You retain ownership of material you submit. You confirm that you have the necessary rights and permissions to submit it. Unless specific entry terms say otherwise, submission does not transfer ownership or guarantee selection, publication, participation, or an award.</p></section>
