...
export default function VoicesPage() {
  return (
    <main>
      ...
      <section className="ibs-section award-cta"><h2>Founding voices will be announced here.</h2><p>Contributions are invitation-led during the founding phase.</p><a className="award-button" href="mailto:worldos@iacy.com?subject=Founding%20Voices">Contribute a perspective</a></section>
    </main>
  );
}
