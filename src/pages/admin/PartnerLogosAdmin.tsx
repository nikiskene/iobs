...
export default function PartnerLogosAdmin() {
  ...
  return <div className="space-y-7">
    <div><p className="text-sm uppercase tracking-[.3em] text-zinc-500">Public website</p><h1 className="mt-3 text-3xl font-semibold text-white">Partner logos</h1><p className="mt-2 text-sm text-zinc-400">Upload, categorize and order the logos displayed above the public footer.</p></div>
